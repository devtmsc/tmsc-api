...
class VTPSchema(DRFStyleBaseModel):
    ORDER_NUMBER: Optional[str] = DRFCharField('ORDER_NUMBER', max_length=50, required=False, blank=True)
    ORDER_REFERENCE: Optional[str] = DRFCharField('ORDER_REFERENCE', max_length=50, required=False, blank=True)
    ORDER_STATUSDATE: Optional[str] = DRFCharField('ORDER_STATUSDATE', max_length=50, required=False, blank=True)
    ORDER_STATUS: Optional[int] = DRFIntField('ORDER_STATUS', required=False)
    STATUS_NAME: Optional[str] = DRFCharField('STATUS_NAME', max_length=200, required=False, blank=True)
    LOCALION_CURRENTLY: Optional[str] = DRFCharField('LOCALION_CURRENTLY', max_length=200, required=False, blank=True)
    NOTE: Optional[str] = DRFCharField('NOTE', max_length=200, required=False, blank=True)
    MONEY_COLLECTION: Optional[int] = DRFIntField('MONEY_COLLECTION', required=False)
    MONEY_TOTAL: Optional[int] = DRFIntField('MONEY_TOTAL', required=False)
    PRODUCT_WEIGHT: Optional[int] = DRFIntField('PRODUCT_WEIGHT', required=False)
