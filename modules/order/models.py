...
class OrdersModel(SoftDeleteMixin, Base):
    ...
    total_weight: Mapped[int] = mapped_column(Integer)
    ...
    is_rewarded: Mapped[int] = mapped_column(Integer)
    sub_status: Mapped[int] = mapped_column(Integer)
    note: Mapped[str] = mapped_column(Text)
    source_id: Mapped[int] = mapped_column(Integer)
    source_note: Mapped[str] = mapped_column(String(200))
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now())
